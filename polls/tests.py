...
class QuestionIndexViewTests(TestCase):
    ...
    def test_two_past_questions(self):
        ...
        """
        question1, question2 = create_question(question_text="Past question 1.", days=-30), create_question(question_text="Past question 2.", days=-5)
        response = self.client.get(reverse('polls:index'))
...
class QuestionDetailViewTests(TestCase):
    ...
    def test_past_question(self):
        """
        The detail view of a question with a published_date date in the past returns True
        """
